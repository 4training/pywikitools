...
class Lang:
    ...
    def __init__(
        ...
        language_code: str,
        country_code: str,
        font_type: FontType = FontType.FONT_STANDARD,
...
LANG_LOCALE: Final[Dict[str, Lang]] = {
    ...
    "hi": Lang(
        "hi", "IN", FontType.FONT_CTL, "Lohit Devanagari"
    ),  # sudo apt-get install fonts-lohit-deva
    "kn": Lang(
        "kn", "IN", FontType.FONT_CTL, "Gentium"
