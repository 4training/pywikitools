...
class TestTranslatedPage(unittest.TestCase):
    ...
    def test_get_iteration_unit(self):
        ...
        retrieved1 = page.get_translation_unit(unit1.identifier)
        retrieved2 = page.get_translation_unit(unit2.identifier)
        notExisting = page.get_translation_unit("not existing")
